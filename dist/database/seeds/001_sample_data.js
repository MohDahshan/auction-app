    ...
    const users = await knex('users').insert([
        {
            ...
            password_hash: '$2a$12$6Ed4EUtaTNiWgz5MHv32C.gMQBe4TqVLIBhzJwr1p8FVOeyxiU5v.',
            name: 'Admin User',
            phone: '+1234567890',
    ...
    await knex('bids').insert([
        {
            ...
            amount: 75,
            is_winning: false,
            bid_time: new Date(now.getTime() - 30 * 60 * 1000)
        },
        {
            auction_id: auctions[0].id,
            user_id: users[2].id,
            amount: 95,
            is_winning: false,
            bid_time: new Date(now.getTime() - 20 * 60 * 1000)
        },
        {
            auction_id: auctions[0].id,
            user_id: users[3].id,
            amount: 120,
            is_winning: true,
            bid_time: new Date(now.getTime() - 10 * 60 * 1000)
        },
        {
            ...
            amount: 150,
            is_winning: false,
            bid_time: new Date(now.getTime() - 45 * 60 * 1000)
        },
        {
            auction_id: auctions[1].id,
            user_id: users[2].id,
            amount: 200,
            is_winning: true,
            bid_time: new Date(now.getTime() - 25 * 60 * 1000)
        },
        {
            ...
            amount: 200,
            is_winning: false,
            bid_time: new Date(now.getTime() - 50 * 60 * 1000)
        },
        {
            auction_id: auctions[2].id,
            user_id: users[2].id,
            amount: 250,
            is_winning: false,
            bid_time: new Date(now.getTime() - 35 * 60 * 1000)
        },
        {
            auction_id: auctions[2].id,
            user_id: users[3].id,
        ...
        },
        {
            ...
            amount: 350,
            is_winning: true,
            bid_time: new Date(now.getTime() - 5 * 60 * 1000)
        },
        {
            ...
            amount: 245,
            is_winning: true,
            bid_time: new Date(oneDayAgo.getTime() + 90 * 60 * 1000)
        },
        {
            auction_id: auctions[4].id,
            user_id: users[2].id,
            amount: 200,
            is_winning: false,
            bid_time: new Date(oneDayAgo.getTime() + 60 * 60 * 1000)
        },
        {
            auction_id: auctions[4].id,
            user_id: users[3].id,
            amount: 150,
            is_winning: false,
            bid_time: new Date(oneDayAgo.getTime() + 30 * 60 * 1000)
        }
    ]);
...
//# sourceMappingURL=001_sample_data.js.map